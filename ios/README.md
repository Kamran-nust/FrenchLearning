...
- Read-only day viewer for all five sections for any of the 301 days
- Unit tests for the plan data and progress logic

Not built yet: Anki sessions, "mark day complete" + streaks, Writing editor + AI feedback, Grammar PDFs,
